...
# DB (use _get so Databricks can inject via secrets). Default SQLite in ghana_dataset for local.
DATABASE_URL = _get("DATABASE_URL") or os.getenv("DATABASE_URL", "sqlite:///ghana_dataset/health.db")
